...
list_1 = List.create(board_id: Board.first.id, name: "Cultural Interview", position_id: 1)
list_2 = List.create(board_id: Board.first.id, name: "Tech Screen/Code Challenge", position_id: 2)
list_3 = List.create(board_id: Board.first.id, name: "Onsite", position_id: 3)
...
card_1 = Card.create(list_id: 2, organization_name: "Wired")
card_1 = Card.create(list_id: 2, organization_name: "Make")
card_1 = Card.create(list_id: 3, organization_name: "Amazon")
